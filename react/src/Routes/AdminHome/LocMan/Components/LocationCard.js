                ...
                <Grid>
                    <Card class="dog" style={{ padding: 5, height: 500, width: "300px" }}>
                        ...
                        <CardMedia component="img" alt="cool dog img" image={this.props.obj.locationImageUrl} title="Cool Dog" style={{ height: "150px", marginTop: "5px" }} />
                            ...
                            {this.props.obj.isLeashRequired ? <p>Leash Required: <span role="img" aria-labelledby="check-mark-button">✅</span></p> : <p>Leash Required: <span role="img" aria-labelledby="cross-mark">❌</span></p> }
                            ...
                            {this.props.obj.hasParking ? <p>Parking:  <span role="img" aria-labelledby="check-mark-button">✅</span></p> : <p>Parking: <span role="img" aria-labelledby="cross-mark">❌</span></p>}
